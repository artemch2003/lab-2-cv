"""
Современное главное окно приложения в стиле фоторедактора.
...
from .components.modern_transform_settings import ModernTransformSettings
from .components.modern_info_panel import ModernInfoPanel
from .components.animations import AnimationManager, LoadingSpinner, ProgressBar
...
class ModernMainWindow:
    ...
    def create_main_workspace(self, parent):
        ...
        # Панель настроек
        self.transform_settings = ModernTransformSettings(workspace_frame, self.on_transform_type_change)
